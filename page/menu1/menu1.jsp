          ...
          <tr>
            ...
            <td>
              <div class="date-field" style="width: 200px">
                <input type="date" id="startDate" class="text-field date-text" value="2025-01-10">
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class="date-field" style="width: 200px">
                <input type="date" id="endDate" class="text-field date-text" value="2025-01-10">
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class="flex align-center col-2">
                <div class="date-field" style="width: 200px">
                  <input type="date" id="startDate1" class="text-field date-text" value="2025-01-10">
                </div>
                <span>~</span>
                <div class="date-field" style="width: 200px">
                  <input type="date" id="endDate1" class="text-field date-text" value="2025-01-10">
                </div>
              </div>
            </td>
          </tr>
